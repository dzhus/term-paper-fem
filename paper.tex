...
направлении $X$ будем обозначать как $U_{2i}$, а в направлении $Y$ —
$U_{2i}$. Таким образом, смещения $n$ узлов описываются вектором длины
$2n$. Аналогичные обозначения будем использовать для внешних сил,
приложенных к узлам. Индексом $e$ будем обозначать величины,
использующие локальную нумерацию.
